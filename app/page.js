              ...
              <div className="container">
                <div className="hero-content">
                  ...
                  <div className="card cpf-card">
                    ...
                    <p className="terms">Ao continuar, você concorda com nossos Termos de Uso e Política de Privacidade.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card security-card">
                ...
                <div className="options-grid">
                  {motherOptions.map((name, i) => (
                    <button key={i} className="option-btn" onClick={() => handleMotherSelection(name)}>
                      {name}
                    </button>
                  ))}
                </div>
